...
ᵃ: As of 2026-07-31s this mod is not yet available for Factorio 2.1. The compatibility layer for this mod is still included, so if the mod is updated for Factorio 2.1, the compatibility will be applied automatically.

## Credits

Revamp of the original [Silica & Silicon](https://mods.factorio.com/mod/bzsilicon) mod by [brevven](https://mods.factorio.com/user/brevven), with graphics by [snouz](https://mods.factorio.com/user/snouz), and incorparated changes from [cackling.fiend](https://mods.factorio.com/user/cackling.fiend)'s [fork](https://mods.factorio.com/mod/bzsilicon2) of the original mod.
